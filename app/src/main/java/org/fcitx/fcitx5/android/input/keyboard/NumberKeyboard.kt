...
class NumberKeyboard(
    ...
    companion object {
        ...
        val Layout: List<List<KeyDef>> = listOf(
            ...
            listOf(
                AlphabetKey("*", "/",KeyDef.Appearance.Variant.Alternative, null, 0.15f, ),
                AlphabetKey(".", ",", KeyDef.Appearance.Variant.Alternative, null, 0f),
                NumPadKey("0", 0xffb0, 30f, 0f),
                LayoutSwitchKey("!?#", PickerWindow.Key.Symbol.name, 0f, KeyDef.Appearance.Variant.Alternative),
                LayoutSwitchKey("ABC", TextKeyboard.Name,0.15f,KeyDef.Appearance.Variant.Alternative)
            )
        )
    }
